...
public class ObstacleControllerSub2 : MonoBehaviour
{
    public ObstacleGeneratorSub2 obsGen;
    ...
    void Start()
    {
        obsGen = GameObject.Find("Sub Obstacle Generator").GetComponent<ObstacleGeneratorSub2>();
